    ...
    <div>
      ...
      <div className="flex space-x-5 px-28 my-10">
        <div className="side_nav h-full w-[30%] p-4 bg-white rounded-2xl flex flex-col">
          ...
          <div className="flex items-center rounded-lg transition duration-500 ease-in-out py-2 px-3 hover:bg-blue-200 space-x-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
              viewBox="0 0 20 20"
          ...
          <div className="flex items-center rounded transition duration-500 ease-in-out py-2 px-3 hover:bg-blue-200 space-x-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
              viewBox="0 0 20 20"
          ...
          <hr className="border border-gray-200 m-0 p-0" />
          <div className="flex items-center rounded-lg py-2 px-3 transition duration-500 ease-in-out hover:bg-blue-200 space-x-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
              viewBox="0 0 20 20"
          ...
          <hr className="border border-gray-200 m-0 p-0" />
          <div className="flex transition duration-500 ease-in-out hover:bg-red-200 items-center space-x-2 rounded-lg py-2 px-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
              viewBox="0 0 20 20"
