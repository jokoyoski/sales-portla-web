          ...
          <div className="flex w-[70%] bg-white rounded-2xl flex-col">
            ...
            <div className="table_content p-3 flex flex-col">
              <div className="flex ">
                ...
                <div className="space-x-5 flex ">
                  <div>
                    <div className="qty border-2 border-gray-300">
                      <input type="number" className=" w-20 p-2" />
                    </div>
                  </div>
                  <div className="price">
                    {" "}
                    <div>
                      <h4 className="font-semibold">#1,750</h4>
                    </div>{" "}
                  </div>
                  <div className="total text-orange-500">
                    ...
                    <div>
                      {" "}
                      <h4 className="font-semibold">#8,750</h4>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="table_content p-3 flex flex-col">
              <div className="flex space-x-4">
                ...
                <div className="total text-orange-500 font-semibold">
                  {" "}
                  <div> #8,750</div>
                </div>
              </div>
