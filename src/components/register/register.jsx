...
export const RegisterComponent = ({
  ...
  return (
    <div className="bg-white md:overflow-hidden lg:h-screen sm:h-full">
      {/* Client Logo */}
      <div className="logo-container space-x-2 flex items-center lg:px-20 md:px-14 sm:px-10 py-3 xm:p-5">
      ...
      {/* End Client Logo */}
      <div className="sm:grid sm:grid-cols-2 sm:pb-5 lg:px-20 md:px-14 sm:px-10 flex flex-col-reverse  justify-center login-continer md:h-screen  sm:items-center xm:p-5">
        {/* Register Boxes */}
        <div className="sm:p-3 xm:p-0 border-r-2 border-gray-200">
          <div className="mt-3 xm:text-center">
            <h1 className="text-3xl font-bold text-[#4f6bfe]">
              Create Account
            </h1>
            <small className="text-gray-300">
              Kindly Enter your details to create your account
            </small>
          </div>
          <ToastContainer />
          <Form onSubmit={submitHandler}>
            <Grid container>
              <div className="relative w-full">
                ...
                />
                <span className="absolute text-[#4f6bfe] top-5 right-20">
                  <svg
              ...
              <div className="w-full ml-2">
                <div
                  className="bg-[rgb(79,107,254)] w-[92%] text-center py-2 rounded-lg text-white w-full"
                ...
                >
                  ...
                  >
                    ...
                    <i
                      className={
                        buttonloader === true ? "fa fa-spinner fa-spin" : ""
                      }
                    ></i>
                  </button>
                </div>
        ...
        {/* Hero-Img */}
        <div className="image-container sm:px-3 sm:pb-5  sm:bg-transparent bg-[#E0F9FE] rounded-2xl">
