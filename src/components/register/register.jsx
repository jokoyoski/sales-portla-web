                ...
                <Form onSubmit={submitHandler}>
                    <Grid container>
                        ...
                        <div className="w-full ml-2">
                            <div className="bg-[rgb(79,107,254)] w-[92%] text-center py-2 rounded-lg text-white w-full" onClick={() => submitHandler}>
                                <button onClick={submitHandler} type="submit" className="text-center focus:outline-none"> Create Account <i className={buttonloader === true ? "fa fa-spinner fa-spin" : ''}></i></button>
                            </div>
                            <div>
